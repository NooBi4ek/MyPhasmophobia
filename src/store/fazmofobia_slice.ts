...
const initialState: ShopState = {
  ...
  ghosts: [
    ...
    },
    {
      ...
      weak: 'Слабая сторона: Использование благовоний рядом с Юрэй заблокирует его возможность перемещения по локации примерно на 90 секунд.',
      evidName: [
        'Минусовая температура',
        'Призрачный огонёк',
        'Лазерный проектор',
    ...
    },
    {
      ...
      strengths:
        'Сильные стороны: Они гораздо более активен в присутствии людей, а материализация призрака в физическом мире наносит сильный удар по рассудку.',
      weak: 'Слабые стороны: Они исчезает во время охоты реже, чем другие виды призраков.',
